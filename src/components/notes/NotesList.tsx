  ...
  return (
    <>
      ...
      <button
        ...
        className="hidden md:flex min-h-[48px] items-center justify-center gap-2 border-t border-gray-200 px-5 py-3 text-sm font-medium text-brand-600 transition hover:bg-gray-50 disabled:opacity-40 dark:border-zinc-800 dark:text-brand-400 dark:hover:bg-zinc-800/50"
      >
